...
////  Explore
////
////  Created by Javius Loh on 9/11/24.
////
//
//import SwiftUI
//import MapKit
...
//    )
//    
//    @State private var chosenLandmarks = [
//        Location(name: "Raffles Statue", coordinate: CLLocationCoordinate2D(latitude: 1.287953, longitude: 103.851784)),
//        Location(name: "Merlion Park", coordinate: CLLocationCoordinate2D(latitude: 1.286788, longitude: 103.854513)),
//        Location(name: "Cecil St", coordinate: CLLocationCoordinate2D(latitude: 1.2826, longitude: 103.848))
//    ]
//
...
//    @Binding var landmarks: [Location]
//
//    var body: some View {
//        VStack(spacing: 10) {
//            // Search bar
...
//                HStack {
//                    Text("\(landmark.name)  \(landmark.distance)")
//                        .foregroundColor(.black)
//                    Spacer()
//                    Toggle("", isOn: $landmark.isVisible)
//                        .labelsHidden()
//                }
//                .padding()
//                .cornerRadius(10)
